...
class GantryDropdownLayout extends AbstractRokMenuLayout
{
	...
	$gantry->addLess('menu.less', 'menu.css', 1, 
                array(
                    ...
                    'buttontextcolor'       => $gantry->get('buttontextcolor',      '#fff'),
                    'headerstyle'           => $gantry->get('headerstyle',          'dark'),
                    'topBorderColor'        => $gantry->get('topBorderColor',       '#252525'),
                    'menupositionbackgroundcolor'   => $gantry->get('menupositionbackgroundcolor',  '#eec60d'),
                    'menupositionbackgroundcolorgradient'   => $gantry->get('menupositionbackgroundcolorgradient',  '#ffc600'),
                    'menubackgroundcolor'   => $gantry->get('menubackgroundcolor',  '#55aadd'),
                    'menubackgroundcolorhover'   => $gantry->get('menubackgroundcolorhover',  '#111111'),
                    'menuHoverColor'        => $gantry->get('menuHoverColor',       '#fff'),
                    'menuShadowColor'        => $gantry->get('menuShadowColor',       '#fff'),
                    'menuItemOutlineColor'        => $gantry->get('menuItemOutlineColor',       '#fff'),
                    'submenuShadowColor'        => $gantry->get('submenuShadowColor',       '#fff'),
                    'submenuTextColor'        => $gantry->get('submenuTextColor',       '#ffffff'),
                    'submenuActiveColor'        => $gantry->get('submenuActiveColor',       '#ffffff'),
                    'submenuHoverColor'        => $gantry->get('submenuHoverColor',       '#ffffff'),
                    'submenuGradientLeftColor'        => $gantry->get('submenuGradientLeftColor',       '#00aaff'),
                    'submenuGradientRightColor'        => $gantry->get('submenuGradientRightColor',       '#dc6e0a'),
                    'mainbackgroundLeftGradientColor'        => $gantry->get('mainbackgroundLeftGradientColor',       '#dc6e0a'),
                    'mainbackgroundRightGradientColor'        => $gantry->get('mainbackgroundRightGradientColor',       '#00AAFF'),
                    'menuTextColor'         => $gantry->get('menuTextColor',        '#405060'),
                    'menuItemRadius'        => $gantry->get('menuItemRadius',       '50%'),
                     'simpleMenu'=> $gantry->get('simpleMenu', 1)
                )
        );
